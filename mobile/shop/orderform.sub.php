...
<div id="sod_frm" class="sod_frm_mobile">
    ...
    #echo G5_MSHOP_PATH.'/'.$default['de_pg_service'].'/orderform.2.php';
    ...
    <?php
    if($is_kakaopay_use) {
        require_once(G5_MSHOP_PATH.'/kakaopay/orderform.3.php');
    }
    ?>
    </form>

    <?php
    #echo G5_MSHOP_PATH.'/'.$default['de_pg_service'].'/orderform.3.php';
...
function pay_approval()
{
    ...
    if( jQuery(pf).triggerHandler("form_sumbit_order_"+form_order_method) !== false ) {
        ...
        if(settle_method != "무통장") {
            ...
            pay_psysapi(settle_method); // 피스시api 호출
            return false;
        } else {
            f.submit();
        }
