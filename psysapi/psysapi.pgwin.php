...
$psysApi = psysapi_get_api_account_info($default, $payTypeCode);
?>
<html lang="ko">
<head>
    <meta charset="UTF-8">
        ...
        success: function(tryPayRes) {
            ...
            $.ajax({
                ...
                beforeSend : function(xhr) {
                    xhr.setRequestHeader("ApiKey", "<?php echo $psysApi['api_key']; ?>");
                },
...
<div>
    ...
    <form name="payform" id="payform" method="post" action="<?php echo PSYSAPI_URL; ?>/psysapi.pay.php">
...
<?php
    ...
    if ($default['de_pg_service'] == 'PSYSAPI_PN') {
?>
    <script>
