...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <ul class="de_pg_tab">
                    ...
                    <?php
                    // s: psysapi-plugin API.PSYS
                    $isPsysApi = strpos($default['de_pg_service'], "PSYS");
                    ?>
                    <li class="<?php if($isPsysApi !== false) echo 'tab-current'; ?>"><a href="#psysapi_info_anchor" data-value="PSYS" title="피시스 API 선택하기">피시스 API</a></li>
                    <?php 
                    // e: psysapi-plugin API.PSYS
                    ?>
        ...
        <?php // s: psysapi-plugin PSYS API ?>

            <tr id="psysapi_info_anchor">
                <th scope="row">
                    <label for="psys_de_pg_service">피시스 API 결제대행사</label><br>
                    <a href="<?php echo PSYS_API_JOIN_URL ?>" target="_blank" class="kg_btn">피시스 API 신청하기</a>
                </th>
                <td>
                    <?php echo help('쇼핑몰에서 사용할 피시스 API 결제대행사를 선택합니다.'); ?>
                    <ul>
                    <?php
                    // 선택된 결제대행사가 없을 경우 초기 선택 지정
                    $i = 0;
                    foreach (PSYS_PG as $psysPgCode => $psysPgName) {
                        $checked = "";
                    
                        if ($default['de_pg_service'] == $psysPgCode) {
                            $checked = "checked";
                        }
                        
                        echo '<label style="margin-right:15px;"><input type="radio" name="psys_de_pg_service" id="psys_de_pg_service_'.$i.'" value="'.$psysPgCode.'" '.$checked.'> '.$psysPgName.'</label>';
            ...
            foreach (PSYS_PG as $psysPgCode => $psysPgName) { 
                $psysPgCodeLower = strtolower($psysPgCode);
            ?>
            <tr class="pg_info_fld psys-pglist <?php echo $psysPgCodeLower; ?>_psys_info_fld" id="<?php echo $psysPgCodeLower; ?>_info_anchor">
                <th scope="row">
                    <label for="de_<?php echo $psysPgCodeLower; ?>_psys_id">피시스<br><?php echo $psysPgName; ?> 연구비<br>연동아이디 &amp; 시크릿키</label>
                </th>
                <td>
                    <?php echo help("피시스 API 에서 발급 받으신 연동 아이디 및 시크릿 키를 입력합니다."); ?>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_id_research" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_id_research"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_id_research" class="frm_input" size="50" maxlength="50" style="margin-bottom:10px;" placeholder="연동 아이디">
                    <br>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_key_research" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_key_research"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_key_research" class="frm_input" size="67" maxlength="50" placeholder="시크릿 키">
                </td>
            </tr>            
            <tr class="pg_info_fld psys-pglist <?php echo $psysPgCodeLower; ?>_psys_info_fld" id="<?php echo $psysPgCodeLower; ?>_info_anchor">
                <th scope="row">
                    <label for="de_<?php echo $psysPgCodeLower; ?>_psys_id">피시스<br><?php echo $psysPgName; ?> 인증<br>연동아이디 &amp; 시크릿키</label>
                </th>
                <td>
                    <?php echo help("피시스 API 에서 발급 받으신 연동 아이디 및 시크릿 키를 입력합니다."); ?>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_id" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_id"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_id" class="frm_input" size="50" maxlength="50" style="margin-bottom:10px;" placeholder="연동 아이디">
                    <br>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_key" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_key"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_key" class="frm_input" size="67" maxlength="50" placeholder="시크릿 키">
                </td>
            </tr>

            <tr class="pg_info_fld psys-pglist <?php echo $psysPgCodeLower; ?>_psys_info_fld">
                <th scope="row"><label for="de_<?php echo $psysPgCodeLower; ?>_psys_id">피시스<br><?php echo $psysPgName; ?> 비인증(수기결제)<br>연동아이디 &amp; 시크릿키</label></th>
                <td>
                    <?php echo help("피시스 API 에서 발급 받으신 연동 아이디 및 시크릿 키를 입력합니다."); ?>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_id_keyin" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_id_keyin"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_id_keyin" class="frm_input" size="50" maxlength="50" style="margin-bottom:10px;" placeholder="연동 아이디">
                    <br>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_key_keyin" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_key_keyin"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_key_keyin" class="frm_input" size="67" maxlength="50" placeholder="시크릿 키">
                </td>
            </tr>
            
            <tr class="pg_info_fld psys-pglist <?php echo $psysPgCodeLower; ?>_psys_info_fld">
                <th scope="row"><label for="de_<?php echo $psysPgCodeLower; ?>_psys_id">피시스<br><?php echo $psysPgName; ?> 웹<br>연동아이디 &amp; 시크릿키</label></th>
                <td>
                    <?php echo help("피시스 API 에서 발급 받으신 연동 아이디 및 시크릿 키를 입력합니다."); ?>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_id_web" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_id_web"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_id_web" class="frm_input" size="50" maxlength="50" style="margin-bottom:10px;" placeholder="연동 아이디">
                    <br>
                    <input type="text" name="de_<?php echo $psysPgCodeLower; ?>_key_web" value="<?php echo get_sanitize_input($default["de_{$psysPgCodeLower}_key_web"]); ?>" id="de_<?php echo $psysPgCodeLower; ?>_key_web" class="frm_input" size="67" maxlength="50" placeholder="시크릿 키">
                </td>
            </tr>

            <tr class="pg_info_fld psys-pglist <?php echo $psysPgCodeLower; ?>_psys_info_fld">
                <th scope="row">
                    <label for="psys_de_pg_service">피시스 API 결제타입</label><br>
                </th>
                <td>
                    <span class="frm_info">쇼핑몰에서 피시스 API로 사용할 결제 타입을 선택합니다.</span>    
                    
                    <!--
                    <ul>
                        <label style="margin-right:15px;">
                            <input type="radio" name="psys_de_pg_service" id="psys_de_pg_service_0" value="PSYS_KW"> 키움페이</label>
                        <label style="margin-right:15px;"><input type="radio" name="psys_de_pg_service" id="psys_de_pg_service_1" value="PSYS_AL"> 모빌페이</label>
                    </ul>
                    -->

                    <ul>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="1" id="de_<?php echo $psysPgCodeLower; ?>_card_type1" <?php if (in_array('1', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type1">1.연구비카드</label>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="3" id="de_<?php echo $psysPgCodeLower; ?>_card_type3" <?php if (in_array('3', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type3">3.일반카드</label>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="4" id="de_<?php echo $psysPgCodeLower; ?>_card_type4" <?php if (in_array('4', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type4">4.키인결제(SMS 인증)</label>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="5" id="de_<?php echo $psysPgCodeLower; ?>_card_type5" <?php if (in_array('5', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type5">5.계좌이체</label>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="6" id="de_<?php echo $psysPgCodeLower; ?>_card_type6" <?php if (in_array('6', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type6">6.가상계좌</label>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="9" id="de_<?php echo $psysPgCodeLower; ?>_card_type9" <?php if (in_array('9', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type9">9.연구비카드+일반카드</label>
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="31" id="de_<?php echo $psysPgCodeLower; ?>_card_type31" <?php if (in_array('31', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type31">31.네이버페이</label>		
                        <input type="checkbox" name="de_<?php echo $psysPgCodeLower; ?>_card_type[]" value="32" id="de_<?php echo $psysPgCodeLower; ?>_card_type32" <?php if (in_array('32', explode(",",$default["de_{$psysPgCodeLower}_card_type"]))) { echo "checked"; } ?>>
                        <label style="margin-right:8px;" for="de_<?php echo $psysPgCodeLower; ?>_card_type32">32.카카오페이</label>	
                    </ul>
...
function psysIdKeySection(){
    var usePgValue = $('input[name="psys_de_pg_service"]:checked').val();
    if (!usePgValue) {
        $(".psys-pglist").css("display", "none");
    } else {
        var usePg = usePgValue.toLowerCase();
        $(".psys-pglist").css("display", "none");
        $(`.${usePg}_psys_info_fld`).css("display", "");
    }
}

function psysChoicePG(){
    
    $('input[name="psys_de_pg_service"]').on("change", function(e){
        var usePgValue = $('input[name="psys_de_pg_service"]:checked').val();
        var usePg = usePgValue.toLowerCase();
